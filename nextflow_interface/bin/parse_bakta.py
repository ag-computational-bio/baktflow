...
def parse_bakta(result_dir: str, sample_name: str):
    ...
    df = pl.read_csv(result_dir,
                     ...
                     skip_rows=6,
                     has_header=False,
                     new_columns=["sequence_id", "type", "start", "stop", "strand", "locus_tag", "gene", "product", "db_ref"])


    json_parse["data"] = df.to_dicts()
...
if __name__ == "__main__":
    ...
    parse_bakta(result_dir, sample_name)