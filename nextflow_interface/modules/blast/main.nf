...
params.silva_db = "${params.databaseDir}/silva_db/silva_db"
...
process BLAST{
        ...
        blastn -query 16S.ffn -db ${params.silva_db} -evalue 1E-10 -outfmt '6 qseqid sseqid length nident bitscore stitle' -num_threads ${task.cpus} > ${meta.sample_id}.16s.tsv
        """
