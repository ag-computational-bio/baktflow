...
process CASFINDER{
    ...
    output:
        ...
        tuple val(report_meta), val('macsyfinder'), path("CasFinder/best_solution.tsv"), emit: report

    script:
    report_meta = meta
    report_meta.finder = 'CasFinder'
    """
...
process CONJSCAN{
    ...
    output:
        ...
        tuple val(meta), val('macsyfinder'), path("CONJScan/best_solution.tsv"), emit: report

    script:
    report_meta = meta
    report_meta.finder = 'CONJScan'
    """
...
process TXSSCAN{
    ...
    output:
        ...
        tuple val(meta), val('macsyfinder'), path("TXSScan/best_solution.tsv"), emit: report

    script:
    report_meta = meta
    report_meta.finder = 'TXSScan'
    """
