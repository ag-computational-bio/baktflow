...
mamba create --yes --quiet -p conda/polish-long-medaka medaka=1.8.0 chardet=5.1.0
mamba create --yes --quiet -p conda/polish-short-polca masurca=4.1.0
...
mamba create --yes --quiet -p conda/bakta bakta=1.8.2
mamba create --yes --quiet -p conda/tax-16-s blast=2.12.0
mamba create --yes --quiet -p conda/vf diamond=2.0.14
mamba create --yes --quiet -p conda/amr-finder-plus ncbi-amrfinderplus=3.11.14
