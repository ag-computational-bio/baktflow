...
mamba create --yes --quiet -p conda/polish-long-medaka medaka=2.0.1
...
mamba create --yes --quiet -p conda/assembly-reorientate dnaapler=1.1.0
...
mamba create --yes --quiet -p conda/bakta bakta=1.10.3 ncbi-amrfinderplus=4.0.3
mamba create --yes --quiet -p conda/tax-16-s blast=2.12.0
mamba create --yes --quiet -p conda/vf diamond=2.0.14
mamba create --yes --quiet -p conda/amr-finder-plus ncbi-amrfinderplus=4.0.3
