...
During execution, Baktaflow may generate temporary files. These files are stored in the default temporary directory of your operating system. Temporary files are automatically deleted upon completion of the pipeline.
## Usage
